...
fn emitQuad(g: Glyph, x: usize, y: usize) void {
    // x: left y: bottom
    // y+ = down
    ...
    state.vertices[state.vertex_count] = p1;
    state.vertices[state.vertex_count + 1] = p2;
    state.vertices[state.vertex_count + 2] = p4;
    state.vertices[state.vertex_count + 3] = p2;
    state.vertices[state.vertex_count + 4] = p3;
    state.vertices[state.vertex_count + 5] = p4;
