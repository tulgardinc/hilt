...
//
//    Cmdline:
//        sokol-shdc -i src/shaders/retry.glsl -o src/shaders/compiled/retry.glsl.zig -l hlsl5 -f sokol_zig
//
//    Overview:
//    =========
//    Shader program: 'retry':
//        Get shader desc: shd.retryShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_retry_pos => 0
...
//            Bind slot: SMP_smp => 1
//
pub const ATTR_retry_pos = 0;
pub const ATTR_retry_uv0 = 1;
...
pub fn retryShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "retry_shader";
    switch (backend) {
        .D3D11 => {
